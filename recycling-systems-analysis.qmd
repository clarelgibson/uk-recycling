...
Eta-squared is `r round(eff$effsize, 3)`, meaning collection system accounts for under `r round(eff$effsize * 100, 1)`% of the variation in recycling rates between local authorities. By the conventional thresholds (0.01 small, 0.06 medium, 0.14 large) this is a small effect. This means that the collection system is not the biggest contributor to the recycling rate.
